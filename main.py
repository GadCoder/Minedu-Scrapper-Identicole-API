...
def save_schools(request_data: RequestData, number_of_pages: int, session: SessionDep, background_tasks: BackgroundTasks):
    background_tasks.add_task(save_schools_from_location, number_of_pages, request_data, session )
